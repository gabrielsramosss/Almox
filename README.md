...
| V   | Tela para listar todos os fornecedores | 2 | Como almoxarife, gostaria de ter acesso ao catálogo de fornecedores | 1-) Irá listar todos os fornecedores com seus respectivos dados |[Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/aa938689871f1024fb6a419ad0c6d95ffbe25359/docs/prototipos/baixa/Listadefornecedores.PNG) |
| VI  | API do google maps | 4 | Como almoxarife gostaria de ter acesso a localização do fornecedor | 1-) Irá ter um mapa onde é possível visualizar todos os endereços dos fornecedores |[Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/aa938689871f1024fb6a419ad0c6d95ffbe25359/docs/prototipos/baixa/perfilfornecedor.PNG) |	
| VII | Tela para listar histórico de compras | 2 | Como almoxarife, gostaria de saber todas as compras feitas no sistema | 1-) Deverá ter a data da compra, o almoxarife que fez a compra, o material da compra com a quantidade e valor, fornecedor. | [Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/f9553a068a0a99d92e4c7b21bf0f56218c81ab86/docs/prototipos/baixa/Historicocompra.PNG)|
| VIII| Tela para cadastrar todo equipamento | 5 | Como almoxarife, gostaria de ter controle de todos os equipamentos da empresa | 1-) Essa tela deverá cadastrar um número de patrimônio para cada equipamento |[Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/f9553a068a0a99d92e4c7b21bf0f56218c81ab86/docs/prototipos/baixa/Cadastrarpatrimo.PNG) |
| IX  | Tela para gerar relatórios | 3 | Como almoxarife, gostaria de criar relatórios para o sistema | 1-) Nessa tela o almoxarife irá selecionar que tipo de relatório ele deseja, de material, requisição, fornecedor, etc. 2-) Depois de escolher qual relatório, o almoxarife vai escolher os filtros disponível para o relatório escolhido. |[Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/f9553a068a0a99d92e4c7b21bf0f56218c81ab86/docs/prototipos/baixa/Geradorderelatorio.PNG) |
| X   | Tela para exportação de relatório | 4 | Como o almoxarife, gostaria de gerar dashboards com os dados gerados pelo gerador de relatórios | 1-) Após gerar o relatório, essa tela irá exportar o relatório como planilha para ser importada no Power BI. |[Acessar protótipo](https://github.com/gabrielsramosss/Almox/blob/f9553a068a0a99d92e4c7b21bf0f56218c81ab86/docs/prototipos/baixa/Exportarela.PNG) |
